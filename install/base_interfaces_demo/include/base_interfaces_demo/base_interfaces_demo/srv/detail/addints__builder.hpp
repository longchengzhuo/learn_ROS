...
public:
  ...
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::base_interfaces_demo::srv::Addints_Response num(::base_interfaces_demo::srv::Addints_Response::_num_type arg)
  {
...
{
  return base_interfaces_demo::srv::builder::Init_Addints_Response_num();
}
